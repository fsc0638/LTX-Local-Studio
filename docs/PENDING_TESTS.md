...
| 後製放大／清理 | 09-09 | OP-POST02 重啟 ltx-post 後：放大 ×2 → 2048×1152、49 幀、QC 通過、191 s；塗遮罩清理（角落 200×120）→ 15 s、QC 通過、CJ 0.7149 vs 清理前 0.7136（未降）。觀察：同 take 同參數重送會重放先前失敗的 job（冪等鍵相同），服務修好後要換 take 或參數才會真的重跑 | D3 |
