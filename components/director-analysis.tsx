...
export const directorCopy = {
  ...
  en: {
    ...
    createsBreakdown: 'This will create the automatic breakdown before running the AI director analysis.',
    ...
    serviceUnavailable: 'OpenAI did not respond or the analysis timed out. Try again later.',
