...
export const breakdownCopy = {
  'zh-TW': {
    ...
    scene: '場景', mood: '氣氛', atmosphere: '視覺氛圍', appearance: '角色外觀',
    wardrobe: '服裝造型', expression: '表情與視線', bodyLanguage: '肢體與姿勢',
    actionAdvice: '動作', progression: '走向', emotion: '情緒', camera: '鏡頭拍法',
    lighting: '光線與色彩', continuity: '前後連戲', breathingAdvice: '呼吸鏡頭',
    prompt: '模型提示詞',
  },
  en: {
    title: 'Breakdown',
    ...
    scene: 'Scene', mood: 'Mood', atmosphere: 'Atmosphere', appearance: 'Character appearance',
    wardrobe: 'Wardrobe', expression: 'Expression and gaze', bodyLanguage: 'Body language',
    actionAdvice: 'Action', progression: 'Direction', emotion: 'Emotion', camera: 'Camera',
    lighting: 'Lighting and colour', continuity: 'Continuity', breathingAdvice: 'Breathing shot',
    prompt: 'Model prompt',
  },
  ja: {
    title: '絵コンテ',
    ...
    scene: '場面', mood: 'ムード', atmosphere: '映像の雰囲気', appearance: '人物の外見',
    wardrobe: '衣装', expression: '表情と視線', bodyLanguage: '身振りと姿勢',
    actionAdvice: '動作', progression: '展開', emotion: '感情', camera: '撮影方法',
    lighting: '照明と色', continuity: '連続性', breathingAdvice: '間のカット',
    prompt: 'モデル用プロンプト',
  },
} as const;
                ...
                <details className="mx-3 mt-2 border border-[#bfe8e3] bg-[#f5fcfb] p-3" open={active}>
                  ...
                  <dl className="mt-3 grid gap-2 md:grid-cols-2">
                    {([
                      ...
                      [text.appearance, suggestion.character_appearance],
                      [text.wardrobe, suggestion.wardrobe],
                      [text.expression, suggestion.facial_expression],
                      [text.bodyLanguage, suggestion.body_language],
                      ...
                      [text.lighting, suggestion.lighting],
                      [text.continuity, suggestion.continuity],
